...
// Usage: > create function distanceudf(string, string) returns double
//          location '/user/cloudera/libudfsample.so' SYMBOL='distanceUDF';
//        > select distanceudf('1,2','3,4');
DoubleVal distanceUDF(FunctionContext* context, const StringVal& arg1, const StringVal& arg2);

// Usage: > create function subudf(int, int) returns int
//          location '/user/cloudera/libudfsample.so' SYMBOL='SubUdf';
//        > select subudf(1, 2);
