...
class AggregateFunctions {
 public:
  ...
  static void MedianInit(FunctionContext* ctx, StringVal* dst);
  static void MedianUpdate(FunctionContext* ctx, const DoubleVal& src, StringVal* dst);
  static void MedianMerge(FunctionContext* ctx, const StringVal& src, StringVal* dst);
  static DoubleVal MedianFinalize(FunctionContext* ctx, const StringVal& src);

  // CORREALTION

  static void CorrInit(FunctionContext* ctx, StringVal* dst);
  static void CorrUpdate(FunctionContext* ctx, const DoubleVal& src1, const DoubleVal& src2, 
		StringVal* dst);
